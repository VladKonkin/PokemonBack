...
namespace PokemonBack.BotBattleAPI.Controllers
{
	...
	public class BattleController : Controller
	{
        ...
        public BattleController(BattleHandler battleHandler, IServiceScopeFactory serviceScope,BattleLogRepository battleLogRepository, ILogger<BattleController> logger)
        {
